...
### 3. Voice Arm: Absolute Economics, Selection Effect & Sensitivity
- **Selection Effect**: Value Recovery Rate (+3.91pp) is driven by deliberate account targeting as much as conversion. Voice intercepts are restricted exclusively to stalled accounts with balances $\ge$ ₹5,000. While the portfolio median balance is ~₹1,200, the voice target accounts average **₹9,185 per recovered case**.
- **Absolute Economics**: Across 20 seeds, the agent placed **5.8 ± 1.2 calls per batch** (incurring **₹29.00** in SIP telephony spend) and recovered **₹16,631.92 ± ₹9,212.37 in net capital**.
...
| **Net ROI Multiple** | 30.91x | 48.52x | 48.53x | **45.39x** |
